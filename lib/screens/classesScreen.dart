...
class ClassesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        elevation: 0,
        title: Text('My Subjects', style: TextStyle(color: Colors.white)),
      ),
        ...
        child: Column(
          ...
          children: [
            ...
            FittedBox(
              child: Row(
                children: [
                  IconCard(title: 'Life Science', image: 'classIcons/dna.png'),
                  IconCard(
                    title: 'Geography',
            ...
            FittedBox(
              child: Row(
                children: [
                  ...
                  IconCard(title: 'Isizulu', image: 'classIcons/african.png')
                ],
              ),
            ),
          ],
